...
#define RIGHT_FORWARD     15  // Left side motor forward
#define RIGHT_BACKWARD    14  // Left side motor backward
#define LEFT_FORWARD      16  // Right side motor forward
#define LEFT_BACKWARD     17  // Right side motor backward
